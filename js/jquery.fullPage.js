...
(function($) {
	...
	//alert(e.view.location.hash)
     ...
     //alert(v.leavingSection)
     //       footer处理

     var linkd = v.anchorLink;
      if(v.leavingSection==5&&v.yMovement=="up"&&a==1)
      {
      	 a=2;
      	 return;
      	}
      	a=1;
			...
			if(typeof v.anchorLink !== 'undefined'){
				setURLHash(slideIndex, slideAnchorLink, linkd);
			}
		...
		*/
		...
		function addTableClass(element){
            ...
            //     var design2_content_height = (getTableHeight(element)-390)/2;
            //     var design3_content_height = (getTableHeight(element)-120)/2;
            //     var design4_content_height = (getTableHeight(element)-150)/2;
            //$('.content .design2 .design2_content').css("margin-top",design2_content_height+"px");
            //$('.content .design3 .design3_content').css("margin-top",design3_content_height+"px");
            //$('.content .design4 .design4_content').css("margin-top",design4_content_height+"px");
            //console.log(getTableHeight(element));
		}
